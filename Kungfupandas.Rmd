...
```python
In []: df.sort_values(by=['col1', 'col2'])
Out[]:
  col1  col2  col3 col4
1    A     1     1    B
0    A     2     0    a
...
```python
In []: df.sort_values(by='col1', ascending=False, na_position='first')
Out[]:
  col1  col2  col3 col4
3  NaN     8     4    D
4    D     2     2    e
...
```
!(gif1)[https://raw.githubusercontent.com/nalepae/pandarallel/master/docs/progress_apply.gif]
