...
Ở ví dụ phía dưới \texttt{col\_1}, \texttt{col\_2}, \texttt{col\_4}, \texttt{col\_5} có thể ép về kiểu \texttt{int}, còn \texttt{col\_3}, \texttt{col\_6} thì không thể ép kiểu được.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{In []: sample\_df.}\BuiltInTok{apply}\NormalTok{(dsum, axis}\OperatorTok{=}\DecValTok{1}\NormalTok{)}
\NormalTok{Out[]: }
\DecValTok{0}     \DecValTok{5}
\DecValTok{1}    \DecValTok{15}
\DecValTok{2}    \DecValTok{25}
...
\NormalTok{In []: sample\_df.}\BuiltInTok{apply}\NormalTok{(dsum\_2, axis}\OperatorTok{=}\DecValTok{1}\NormalTok{)}
\NormalTok{Out[]: }
\DecValTok{0}\NormalTok{      [}\DecValTok{5}\NormalTok{, }\OperatorTok{{-}}\DecValTok{3}\NormalTok{]}
\DecValTok{1}\NormalTok{     [}\DecValTok{15}\NormalTok{, }\OperatorTok{{-}}\DecValTok{9}\NormalTok{]}
\DecValTok{2}\NormalTok{    [}\DecValTok{25}\NormalTok{, }\OperatorTok{{-}}\DecValTok{15}\NormalTok{]}
\NormalTok{dtype: }\BuiltInTok{object}
\end{Highlighting}
\end{Shaded}
...
\section{Aggregate trong Groupby}\label{aggregate-trong-groupby}
