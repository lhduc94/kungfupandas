...
Phương thức loc dùng để lấy dữ liệu theo cột hoặc hàng dựa theo nhãn định sẵn (Tên hàng, tên cột), ngoài ra \texttt{.loc} còn nhận các giá trị boolean.
...
\hypertarget{sux1eed-dux1ee5ng-column-element-wise}{%
\section{Sử dụng column element-wise}\label{sux1eed-dux1ee5ng-column-element-wise}}
